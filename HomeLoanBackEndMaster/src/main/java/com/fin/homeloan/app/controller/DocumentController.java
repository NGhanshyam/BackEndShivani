...
public class DocumentController {
	...
	@Autowired
	DocumentService serviced;
	
	@PostMapping(value="/save/{applicantId}",consumes=MediaType.MULTIPART_FORM_DATA_VALUE)
	public String saveDocument(@PathVariable int applicantId,@RequestPart (required = true,value = "adharCard") MultipartFile f1,
            ...
            
  {
	  ...
	  d.setG_PropertyDoc(f10.getBytes());
		...
		Applicant a=service.get(applicantId);
		d.setApplicant(a);
